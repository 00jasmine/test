...
import com.team.entity.Insurance;
import com.team.vo.StaffInsuranceVO;
...
public interface InsuranceMapper extends BaseMapper<Insurance> {
    ...
    @Select("select ss.id staff_id,ss.code,ss.name,ss.phone,ss.address,sd.name dept_name," +
            ...
            "(hrm.sys_staff ss left join hrm.sys_dept sd on ss.dept_id = sd.id) left join hrm.soc_insurance si on si.staff_id = ss.id " +
