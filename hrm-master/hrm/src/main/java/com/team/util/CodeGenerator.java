...
public class CodeGenerator {
    public static void main(String[] args) {
        DataSourceConfig dataSourceConfig = new DataSourceConfig
                .Builder("jdbc:mysql://localhost:3306/hrm?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai", "root", "000000")
        ...
        GlobalConfig globalConfig = new GlobalConfig.Builder()
                ...
                .outputDir("D:\\新建文件夹\\asus\\Desktop\\code\\java")  // 输出路径为当前项目的/src/main/java目录下
                .author("qiujie")
        ...
        PackageConfig packageConfig = new PackageConfig.Builder()
                ...
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D:\\新建文件夹\\asus\\Desktop\\code\\mapper")) // 设置mapperXml生成路径
                .build();
